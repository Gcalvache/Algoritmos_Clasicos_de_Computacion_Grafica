...
namespace AlgortimosDibujarLinea
{
    public partial class frmMetodoRellenoFlood : Form
    {
        ...
        private async void BtnCalcular_Click(object sender, EventArgs e)
        {
            ...
            var fillPoints = await Task.Run(() => CRelleno.FloodFillSeed(seed, boundarySet, false));
            ...
            using (Graphics g = Graphics.FromImage(pcbGrafico.Image))
            using (var fillBrush = new SolidBrush(Color.FromArgb(200, 100, 220, 100)))
            using (var penFill = new Pen(Color.FromArgb(160, 30, 100, 30), 1))
            {
                ...
                // choose delay: if too many pixels, skip delay to keep reasonable performance
