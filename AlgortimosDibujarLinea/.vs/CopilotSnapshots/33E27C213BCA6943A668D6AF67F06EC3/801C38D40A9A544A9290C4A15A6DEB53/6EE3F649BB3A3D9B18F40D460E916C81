...
{
    public partial class frmMetodoLineaBresenham : Form
    {
        public frmMetodoLineaBresenham()
        {
            InitializeComponent();
        ...
        private void BtnCalcular_Click(object sender, EventArgs e)
        {
            ...
            // Usar siempre Bresenham en este formulario
            var puntos = linea.Discretize(Clinea.LineAlgorithm.Bresenham);
