...
namespace AlgortimosDibujarLinea
{
    public partial class frmMetodoCirculoBresenham : Form
    {
        ...
        // Local Bresenham circle point generator (integer algorithm)
        ...
        private void BtnCalcular_Click(object sender, EventArgs e)
        {
            ...
            {
                // High quality for overlay
                g.SmoothingMode = SmoothingMode.HighQuality;
                g.Clear(pcbGrafico.BackColor);

                // Compute grid spacing in pixels; avoid too dense grid
                float spacing = scale;
                if (spacing < 6f)
                {
                ...
                // Map world (x,y) -> screen point; center the circle center at screen center
