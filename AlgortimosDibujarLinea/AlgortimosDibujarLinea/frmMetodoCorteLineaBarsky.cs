...
namespace AlgortimosDibujarLinea
{
    ...
    /// El formulario permite definir dos puntos mediante clics y ver la línea original
    /// y la línea recortada. El algoritmo de recorte se encuentra en el módulo de
    /// recorte de líneas y se integra de forma modular.
    /// </summary>
