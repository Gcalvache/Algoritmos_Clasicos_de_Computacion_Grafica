...
{
    public partial class frmMetodoLineaPuntoMedio : Form
    {
        public frmMetodoLineaPuntoMedio()
        {
            InitializeComponent();
        ...
        private void BtnCalcular_Click(object sender, EventArgs e)
        {
            ...
            // Usar siempre Punto Medio en este formulario
            var puntos = linea.Discretize(Clinea.LineAlgorithm.Midpoint);
